...
contract SupplyChainStorage is SupplyChainStorageOwnable {
    ...
    */
    ...
    function setFarmInspectorData(address batchNo,
        ...
        farmInspectorData.teaFamily = _teaFamily;
    ...
    function getFarmInspectorData(address batchNo) public onlyAuthCaller returns (string memory teaFamily,string memory typeOfSeed,string memory fertilizerUsed){
        
        farmInspector memory tmpData = batchFarmInspector[batchNo];
        return (tmpData.teaFamily, tmpData.typeOfSeed, tmpData.fertilizerUsed);
    }
