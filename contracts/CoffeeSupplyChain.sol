...
contract TeaSupplyChain is Ownable
{
    ...
    function getFarmInspectorData(address _batchNo) public returns (string memory teaFamily,string memory typeOfSeed,string memory fertilizerUsed) {
        /* Call Storage Contract */
        (teaFamily, typeOfSeed, fertilizerUsed) = supplyChainStorage.getFarmInspectorData(_batchNo);  
        return (teaFamily, typeOfSeed, fertilizerUsed);
    }
    
    /* perform Farm Inspection */
    
    function updateFarmInspectorData(address _batchNo,
                                    string memory _teaFamily,
                                    string memory _typeOfSeed,
                                    string memory _fertilizerUsed) 
                                public isValidPerformer(_batchNo,'FARM_INSPECTION') returns(bool) {
        /* Call Storage Contract */
        bool status = supplyChainStorage.setFarmInspectorData(_batchNo, _teaFamily, _typeOfSeed, _fertilizerUsed);  
